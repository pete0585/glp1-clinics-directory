...
export default async function CityPage() {
  ...
  const faqLd = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "How many glp-1 weight loss clinic are in San Antonio, TX?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "GLP-1 Weight Loss Clinic Directory lists 42+ glp-1 weight loss clinic in San Antonio, Texas. Counts change as new listings are seeded.",
        },
      },
      {
        "@type": "Question",
        name: "How do I find glp-1 weight loss clinic in San Antonio?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Search findglp1clinic.com and filter by San Antonio. Compare listed providers, then contact the one that fits.",
        },
      },
    ],
  }
    ...
    <>
      ...
      <main className="mx-auto max-w-5xl px-4 py-10">
        ...
        <h1 className="mt-2 text-3xl font-bold tracking-tight">
          GLP-1 Weight Loss Clinic in San Antonio, TX
        </h1>
        <p className="mt-3 max-w-2xl text-neutral-600">
          42+ listed glp-1 weight loss clinic in the San Antonio area. Pages are generated from live directory listings — not outreach.
        </p>
